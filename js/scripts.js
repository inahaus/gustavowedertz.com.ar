...
var   window_height = $(window).height(),
      testMobile,
	  loadingError = '<p class="error">El contenido no puede cargarse.</p>',
	  nameError = '<div class="alert alert-error">Por favor ingrese su nombre.</div>',
	  emailError = '<div class="alert alert-error">Por favor ingrese su direccion de e-mail.</div>',
	  invalidEmailError = '<div class="alert alert-error">Por favor ingrese una direccion de e-mail valida.</div>',	  
	  subjectError = '<div class="alert alert-error">Por favor ingrese el asunto.</div>',
	  messageError = '<div class="alert alert-error">Por favor ingrese su mensaje.</div>',	
	  mailSuccess = '<div class="alert alert-success">Su mensaje ha sido enviado. ¡Gracias!</div>', 
